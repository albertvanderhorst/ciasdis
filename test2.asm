...
( 0000,056A )                  LEA, AX'| BO|    [AX +4* AX] 0000,0000 B, 
( 0000,056E )                  LEA, AX'| XO|    [AX +4* AX] 0000,000C L, 
( 0000,0575 )                  OS:, 
( 0000,0576 )                  LEA, AX'| XO|    [AX +4* AX] 0000,000D L, 
( 0000,057D )                  AS:, 
( 0000,057E )                  LEA, AX'| XO| [BX+SI]' 0000,000E W, 
( 0000,0582 )                  AS:, 
( 0000,0583 )                  OS:, 
( 0000,0584 )                  LEA, AX'| XO| [BX+SI]' 0000,000F W, 
( 0000,0588 )                  OS:, 
( 0000,0589 )                  AS:, 
( 0000,058A )                  LEA, AX'| XO| [BX+SI]' 0000,0010 W, 
( 0000,058E )                  RET, 
( 0000,058F )                  INC|X, AX| 
( 0000,0590 )                  MOVI, X| XO| [BX] 0000,000E L, 0000,0012 IL, 
( 0000,059A )                  INC|X, AX| 
( 0000,059B )                  OS:, 
( 0000,059C )                  MOVI, X| XO| [BX] 0000,000E L, 0000,0012 IW, 
( 0000,05A4 )                  INC|X, AX| 
( 0000,05A5 )                  AS:, 
( 0000,05A6 )                  MOVI, X| XO| [BX]' 0000,0014 W, 0000,0018 IL, 
( 0000,05AE )                  AS:, 
( 0000,05AF )                  OS:, 
( 0000,05B0 )                  MOVI, X| XO| [BX]' 0000,0014 W, 0000,0018 IW, 
( 0000,05B6 )                  RET, 
( 0000,05B7 )               
...
( 0000,05B8 )                  AS:, 
( 0000,05B9 )                  OS:, 
( 0000,05BA )                  MOVI, X| XO| [BX] 0000,000E L, 0000,0012 IL, 
( 0000,05C4 )                  INC|X, AX| 
( 0000,05C5 )                  AS:, 
( 0000,05C6 )                  MOVI, X| XO| [BX] 0000,000E L, 0000,0012 IW, 
( 0000,05CE )                  INC|X, AX| 
( 0000,05CF )                  OS:, 
( 0000,05D0 )                  MOVI, X| XO| [BX]' 0000,0014 W, 0000,0018 IL, 
( 0000,05D8 )                  MOVI, X| XO| [BX]' 0000,0014 W, 0000,0018 IW, 
( 0000,05DE )                  RET, 
( 0000,05DF )   :YYY 
