...
# 2003/03/23 :
# macro cword and symbolic chars introduced by Albert van der Horst (DFW)

# All chars are defined in octal
# 4 bits chars.
.equ C_     ,           00
.equ C_r    ,            01
.equ C_t    ,            02
...
# Auxiliary macro, update ``shifter'' and vuild up ``colorword''
.macro   pcword C1=0,N1=0,C2=0,N2=0,C3=0,N3=0,C4=0,N4=0,C5=0,N5=0,C6=0,N6=0,C7=0,N7=0,C8=0,N8=0
.set    shifter, shifter-\N1
.if     \N1
.set    colorword, colorword <<\N1 + \C1
pcword \C2,\N2,\C3,\N3,\C4,\N4,\C5,\N5,\C6,\N6,\C7,\N7,\C8,\N8
.endif
.endm

# Define a colorword from the char's C1 .. C8 , N1 .. N8 must be the corresponding length
# Specify only the char's you need.
# (Could have done a better job with m4, sorry.)
.macro   cword C1=0,N1=0,C2=0,N2=0,C3=0,N3=0,C4=0,N4=0,C5=0,N5=0,C6=0,N6=0,C7=0,N7=0,C8=0,N8=0
.set    shifter, 0
.set    colorword, 0
pcword \C1,\N1,\C2,\N2,\C3,\N3,\C4,\N4,\C5,\N5,\C6,\N6,\C7,\N7,\C8,\N8
        .int colorword <<shifter
.endm
...
#       dd 173o shl 25 ; +
macro0:         cword C7_SEMIS,7,    # ;
        cword C7_d,7,  C7_u,7,  C7_p,7,    # dup
        cword C7_QUERY,7,  C7_d,7,  C7_u,7,  C7_p,7,    # ?dup
        cword C7_d,7,  C_r,4,  C_o,4,  C7_p,7,    # drop
#       dd ((6 shl 4+7)shl 7+142o)shl 17 ; nip
        cword C_t,4,  C7_h,7,  C_e,4,  C_n,4,    # then
        cword C7_b,7,  C_e,4,  C5_g,5,  C_i,4,  C_n,4,    # begin
macro1:         .rept 128
        .int 0
        .endr
forth0: cword C7_b,7,  3,4,  C_o,4,  C_t,4,    # boot
        .int 0x82e14000 #save
        cword   C5_f,5, C_r,4, C_a,4, C5_m,5, C_e,4 #frame
        cword C7_p,7,  C_a,4,  C7_u,7,  C5_s,5,  C_e,4,    # pause
        cword C5_m,5,  C_a,4,  C5_c,5,  C_r,4,  C_o,4,    # MACRO
        cword C5_f,5,  C_o,4,  C_r,4,  C_t,4,  C7_h,7,    # FORTH
        cword C5_c,5,    # c
        cword C_n,4,  C5_c,5,    # nc
        cword C_a,4,  C5_c,5,  C_t,4,    # ACT
#       cword C5_s,5,  C7_h,7,  C_e,4,  C5_w,5,
        cword C5_s,5, C7_h,7, C_o,4, C5_w,5     # SHOW
        cword C5_l,5,  C_o,4,  C_a,4,  C7_d,7,    # LOAD
        cword C7_h,7,  4,4,  C_r,4,  C_e,4,    # here
        cword C7_QUERY,7,  C5_l,5,  C_i,4,  C_t,4,    # ?lit
        cword C7_3,7,  C7_COMMA,7,    # 3,
        cword C7_j,7,  C7_COMMA,7,    # 2,
        cword C7_z,7,  C7_COMMA,7,    # 1,
        cword C7_COMMA,7,    # ,
        cword C5_l,5,  C_e,4,  020,5,  C5_s,5,    # less
        cword C7_1,7,  C7_u,7,  C5_m,5,  C7_p,7,    # jump
        cword C_a,4,  022,5,  C5_c,5,  C_e,4,  C7_p,7,  C_t,4,    # accept
        cword C7_p,7,  C_a,4,  C7_d,7,    # pad
        cword C_e,4,  C_r,4,  C_a,4,  C5_s,5,  C_e,4,    # erase
        cword C5_c,5,  C_o,4,  C7_p,7,  C5_y,5,    # copy
        cword C5_m,5,  C_a,4,  C_r,4,  C7_0,7,    # mark
        cword C_e,4,  C5_m,5,  C7_p,7,  C_t,4,    # empt
        cword C_e,4,  C5_m,5,  C_i,4,  C_t,4,    # emit
        cword C7_d,7,  7,4,  C5_g,5,  C_i,4,  C_t,4,    # digit
        cword C7_j,7,  C_e,4,  C5_m,5,  C_i,4,  C_t,4,    # 2emit
        cword C7_DOT,7,    # .
        cword C7_h,7,  C7_DOT,7,    # h.
        cword C7_h,7,  C7_DOT,7,  C_n,4,    # h.n
        cword C5_c,5,  C_r,4,    # CR
        cword C5_s,5,  C7_p,7,  C_a,4,  C5_c,5,  C_e,4,    # space
        cword C7_d,7,  C_o,4,  C5_w,5,  C_n,4,    # DOWN
        cword C_e,4,  C7_d,7,  C_i,4,  C_t,4,    # edit
        .int 4 << 28# E
#       dd (((26o shl 4+3)shl 4+6)shl 4+2)shl 15 ; font
        cword C5_l,5,  C5_m,5,    # lm
        cword C_r,4,  C5_m,5,    # rm
        cword C5_g,5,  C_r,4,  C_a,4,  C7_p,7,  C7_h,7,    # graph ic
        cword C_t,4,  C_e,4,  C7_x,7,  C_t,4,    # text
...
#       dd (((20o shl 4+7)shl 7+140o)shl 4+4)shl 12 ; side
        cword C7_0,7,  C_e,4,  C5_y,5,  C7_b,7,  C_o,4,    # keybo ard
        cword C7_d,7,  C_e,4,  C7_b,7,  C7_u,7,    # debu g
        cword C_a,4,  C_t,4,    # at
        cword C7_PLUS,7,  C_a,4,  C_t,4,    # +at
        cword C7_x,7,  C5_y,5,    # xy
        cword C5_f,5,  C_o,4,  C7_v,7,    # fov
        cword C5_f,5,  C_i,4,  C5_f,5,  C_o,4,    # fifo
        cword C7_b,7,  C_o,4,  C7_x,7,    # box
        cword C5_l,5,  C_i,4,  C_n,4,  C_e,4,    # line
        cword C5_c,5,  3,4,  C5_l,5,  C_o,4,  C_r,4,    # color
#       dd (((22o shl 5+24o)shl 4+7)shl 7+142o)shl 11 ; clip
        cword C_o,4,  C5_c,5,  2,4,  C_a,4,  C_n,4,  C_t,4,    # octant
        cword C5_s,5,  C7_p,7,    # sp
        cword C5_l,5,  C_a,4,  C5_s,5,  C_t,4,    # last
        cword C7_u,7,  C_n,4,  C7_p,7,  C_a,4,  C5_c,5, )   # unpac k
...
numb0:  .int nul0, minus, alphn, octal
